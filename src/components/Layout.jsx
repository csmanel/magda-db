                ...
                <div key={table.id} className="group relative">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-gray-500 ml-2">{table.schema?.columns?.length || 0}</span>
                    </div>
                  </Link>
                  <button
                  ...
                  {newTable.columns.map((col, index) => (
                    <div key={index} className="flex gap-2">
                      ...
                      <select
                        ...
                        className="px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white text-sm"
                      >
